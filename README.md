...
A lightweight terminal-based toolkit for easier **Git collaboration** in teams.  
Includes a menu system for:

- Starting new features and branches
- Reviewing & merging pull requests
- Git status, pull, and fetch
- Branch management (switching/deleting)
